...
def generate_credit_portfolio(n_borrowers=200, seed=42, output_file="credit_portfolio.csv"):
    """
    ...
    sectors = np.random.choice(
        ["Technology", "Financials", "Energy", "Healthcare", "Consumer Defensive", "Industrials", "Utilities"],
        size=n_borrowers,
    ...
    adjustment = np.log(target_default_rate / (1 - target_default_rate)) - np.log(current_rate / (1 - current_rate))
