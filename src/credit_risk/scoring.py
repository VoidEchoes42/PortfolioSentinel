...
def assign_credit_rating(pd_score: float) -> str:
    ...
    if pd_score < 0.005: return "AAA"
    elif pd_score < 0.01: return "AA"
    elif pd_score < 0.02: return "A"
    elif pd_score < 0.04: return "BBB"
    elif pd_score < 0.08: return "BB"
    elif pd_score < 0.15: return "B"
    elif pd_score < 0.25: return "CCC"
    else: return "D"
