...
tab1, tab2, tab3 = st.tabs(
    ["Performance & Drawdown", "Volatility & Correlation", "VaR & Monte Carlo"]
)
...
with tab3:
    ...
    with st.spinner("Running Monte Carlo..."):
        mc_results = run_monte_carlo_simulation(
            returns, weights, num_simulations=mc_sims
        )
    ...
    with colY:
        ...
        st.info(
            "The Monte Carlo simulation projects potential portfolio outcomes over the next 21 trading days assuming multivariate normal distributions."
        )
